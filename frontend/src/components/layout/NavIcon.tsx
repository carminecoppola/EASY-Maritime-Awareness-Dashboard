...
const PATHS: Record<NavIconName, string> = {
  ...
  // riquadro di rilevamento con bersaglio: l'inferenza disegna bounding box
  analysis: 'M2 5.5V2.5h3M16 5.5V2.5h-3M2 12.5v3h3M16 12.5v3h-3M9 6.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5Z',
  // onda termica
  ...
  // due persone stilizzate — gestione utenti/ruoli
  users:
    'M6.5 8.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Zm5.7.3a2.1 2.1 0 1 0 0-4.2 2.1 2.1 0 0 0 0 4.2ZM2 15c0-2.5 2-4.2 4.5-4.2S11 12.5 11 15M11.7 10.9c2 .1 3.6 1.6 3.6 4.1',
}
